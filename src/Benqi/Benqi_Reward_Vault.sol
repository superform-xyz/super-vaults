...
// contract BenqiRewardsVault is ERC4626 {
...
//     IRewadsCore public rewardsCore;

//     mapping(address => uint256) public userApplicableQitokens;
...
//         rewardsCore = IRewadsCore(_rewardsCore);
//     }
...
//         uint256 beforeCTokenBal = cToken.balanceOf(address(this));
//         // mint tokens
//         require(cToken.mint(underlyingAmount) == 0, "MINT_FAILED");
//         userApplicableQitokens[msg.sender] = cToken.balanceOf(address(this)) - beforeCTokenBal;
//         rewardsCore.updateDeposits(msg.sender, userApplicableQitokens[msg.sender]);
//     }

...
contract AaveV3ERC4626ReinvestUniFactory {
    ...
    event CreateERC4626Reinvest(ERC20 indexed asset, AaveV3ERC4626ReinvestUni vault);
    ...
    function createERC4626(ERC20 asset_) external virtual returns (AaveV3ERC4626ReinvestUni vault) {
    ...
    function setRewards(AaveV3ERC4626ReinvestUni vault_) external returns (address[] memory rewards) {
        if (msg.sender != manager) revert INVALID_ACCESS();
